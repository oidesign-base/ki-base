...
-- Safe to run once after the schema (schema.sql, or 001_init.sql + later migrations).
-- Names are in the UI language (Polish).
...
SELECT id, 'views',      'Wyświetlenia', 'views',    10 FROM platforms WHERE code = 'etsy'
UNION ALL
SELECT id, 'favorites',  'Ulubione',     'interest', 20 FROM platforms WHERE code = 'etsy'
UNION ALL
SELECT id, 'views',      'Wyświetlenia', 'views',    10 FROM platforms WHERE code = 'vinted'
UNION ALL
SELECT id, 'favourites', 'Ulubione',     'interest', 20 FROM platforms WHERE code = 'vinted'
UNION ALL
SELECT id, 'views',      'Wyświetlenia', 'views',    10 FROM platforms WHERE code = 'olx'
UNION ALL
SELECT id, 'observed',   'Obserwujący',  'interest', 20 FROM platforms WHERE code = 'olx';
