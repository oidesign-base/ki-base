...
Кожна наступна зміна структури — новий файл `migrations/005_….sql`; `schema.sql` оновлюється разом із ним.
...
erDiagram
    ...
    code_prefixes ||--o{ code_sheets : "серія"
